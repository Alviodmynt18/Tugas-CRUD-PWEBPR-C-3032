...
function readFormData() {
  var formData = {};
  formData["IdLagu"] = document.getElementById("IdLagu").value;
  formData["NamaLagu"] = document.getElementById("NamaLagu").value;
  formData["Singer"] = document.getElementById("Singer").value;
  formData["Deskripsi"] = document.getElementById("Deskripsi").value;
  formData["LinkLagu"] = document.getElementById("LinkLagu").value;
...
function insertNewRecord(data) {
  ...
  cell1.innerHTML = data.IdLagu;
  var cell2 = newRow.insertCell(1);
  cell2.innerHTML = data.NamaLagu;
...
function onEdit(td) {
  ...
  document.getElementById("IdLagu").value = selectedRow.cells[0].innerHTML;
  document.getElementById("NamaLagu").value = selectedRow.cells[1].innerHTML;
...
//Reset the data
function resetForm() {
  document.getElementById("IdLagu").value = "";
  document.getElementById("NamaLagu").value = "";
  document.getElementById("Singer").value = "";
  document.getElementById("Deskripsi").value = "";
  document.getElementById("LinkLagu").value = "";
